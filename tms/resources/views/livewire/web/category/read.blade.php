            ...
            <div class="card-header p-0">
                ...
                <div class="px-2 mt-4">
                    ...
                    <div class="row justify-content-between mt-4 mb-4">
                        @if(getCrudConfig('Category')->create && hasPermission('web.category.create', 0, 0))
                        <div class="col-md-4 right-0">
                            <a href="@route('web.category.create')" class="btn btn-success">{{ __('CreateTitle', ['name' => __('Category') ]) }}</a>
                        </div>
                        @endif
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        @foreach($categorys as $category)
                            @livewire('web.category.single', [$category], key($category->id))
                        @endforeach
                    </tbody>
                </table>
            </div>
