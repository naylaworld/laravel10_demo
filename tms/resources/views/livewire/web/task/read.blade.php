            ...
            <div class="card-header p-0">
                ...
                <div class="px-2 mt-4">
                    ...
                    <div class="row justify-content-between mt-4 mb-4">
                        @if(getCrudConfig('Task')->create && hasPermission('web.task.create', 0, 0))
                        <div class="col-md-4 right-0">
                            <a href="@route('web.task.create')" class="btn btn-success">{{ __('CreateTitle', ['name' => __('Task') ]) }}</a>
                        </div>
                        @endif
                ...
                <table class="table table-hover table-striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style='cursor: pointer' wire:click="sort('due_date')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'due_date') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'due_date') fa-sort-amount-up ml-2 @endif'></i> {{ __('Due_date') }} </th>
                    ...
                    <tbody>
                        @foreach($tasks as $task)
                            @livewire('web.task.single', [$task], key($task->id))
                        @endforeach
                    </tbody>
                </table>
            </div>
