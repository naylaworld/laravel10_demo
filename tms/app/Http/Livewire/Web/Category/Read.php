...
class Read extends Component
{
    ...
    protected $listeners = ['categoryDeleted'];
    ...
    public function render()
    {
        ...
        $instance = getCrudConfig('Category');
        ...
        return view('livewire.web.category.read', [
            'categorys' => $data
        ])->layout('web::layouts.app', ['title' => __(\Str::plural('Category')) ]);
    }
}
